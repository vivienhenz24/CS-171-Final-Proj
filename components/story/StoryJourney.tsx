  ...
  return (
    <DataProvider>
      <div className="flex flex-col min-h-screen bg-black text-white">
        ...
        {page === 2 && <PageTwo onPrev={() => setPage(1)} onNext={() => setPage('2b')} />}
        {page === '2b' && <PageTwoPartB onPrev={() => setPage(2)} onNext={() => setPage(3)} />}
        {page === 3 && <PageThree onBack={() => setPage('2b')} onNext={() => setPage(4)} />}
